...
\nobibliography{ref}
\begin{enumerate}
	\item \bibentry{2025DPGomoryHu}
	\item \bibentry{2025DPQuantiles}
	\item \bibentry{2025TraceReconstruction}
	\item \bibentry{2025FrequentDirections}
	\item \bibentry{2025LightweightLDP}
	\item \bibentry{2025DPexpander}	
	\item \bibentry{2025HardPredictions}
...
\end{rSection}
 ...
 \begin{itemize}
 \item \textbf{ICALP 2025} Near-Optimal Trace Reconstruction for Mildly Separated Strings
 ...
 \begin{itemize}
  \item  \textbf{ICML 2025} Joint Presentation: Lightweight Protocols for Distributed Private Quantile Estimation
  \item  \textbf{ICML 2025} Joint Presentation: Breaking the $n^{1.5}$ Additive Error Barrier for Private and Efficient Graph Sparsification via Private Expander Decomposition
  \item  \textbf{ICML 2025} Joint Presentation: Improved Approximations for Hard Graph Problems using Predictions
  \item  \textbf{NeuIPS 2024} Joint Presentation: Statistical-Computational Trade-Offs for Density Estimation
...
\begin{rSection}{Teaching experience}
 \begin{itemize}
 \item Course organizer of \emph{Topics in Algorithms and Complexity} (UCPH, DIKU) \hfill{\emph{2025}}
...
\item Reviewer for conferences and journals: NeurIPS, ICLR, JACM, STOC, FOCS, SODA, ICALP, SoCG, ESA, SOSA, RANDOM, ITCS, CPM.
\end{itemize}
